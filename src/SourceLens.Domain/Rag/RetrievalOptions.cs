...
public class RetrievalOptions
{
    ...
    /// <summary>
    /// Расширять первый (самодостаточный) вопрос диалога отдельным вызовом LLM перед ретривом:
    /// нормализация фразы, разворачивание аббревиатур, добавление ключевых синонимов (точнее, но
    /// добавляет один LLM-вызов и задержку на старте каждого диалога).
    /// </summary>
